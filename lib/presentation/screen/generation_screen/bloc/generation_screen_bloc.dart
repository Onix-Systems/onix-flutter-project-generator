  ...
  FutureOr<void> _onGenerateProject(
    ...
    if (!state.config.projectExists) {
      ...
      gitGetBrickProcess.stdin.writeln(
          'curl -L https://github.com/Onix-Systems/onix-flutter-project-generator/archive/refs/heads/fix/gen_empty_source_folders.zip --output brick.zip && unzip -qq brick.zip -d bricks && rm brick.zip');
      // gitGetBrickProcess.stdin.writeln(
      ...
      mainProcess.stdin.writeln(
          'mason add -g flutter_clean_base --path \'${state.config.projectPath}/bricks/onix-flutter-project-generator-fix-gen_empty_source_folders/bricks/flutter_clean_base\'');
