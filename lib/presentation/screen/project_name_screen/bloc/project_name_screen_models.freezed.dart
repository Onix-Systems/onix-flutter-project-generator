...
mixin _$ProjectNameScreenState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(
            Config config, bool isValidProjectName, List<String> branches)
        data,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $ProjectNameScreenStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Config config, bool isValidProjectName, List<String> branches});
...
class _$ProjectNameScreenStateDataImpl implements ProjectNameScreenStateData {
  ...
  @override
  String toString() {
    return 'ProjectNameScreenState.data(config: $config, isValidProjectName: $isValidProjectName, branches: $branches)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return data(config, isValidProjectName, branches);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return data?.call(config, isValidProjectName, branches);
  }
