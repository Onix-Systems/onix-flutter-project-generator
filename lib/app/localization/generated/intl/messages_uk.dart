...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(children) =>
      "Клас залежить від ${children} котрих ще не існує.\nЗгенерувати їх?";

  static String m1(type) => "Додати ${type} параметри";

  static String m2(componentName) => "${componentName} вже існує";

  static String m3(variant) =>
      "Зміна стейт мененджера змінить ... на ${variant}. Дійсно бажаєте продовжити?";

  static String m4(componentName) => "Перегляд компонента ${componentName}";

  static String m5(componentName) => "Компонент ${componentName} вже існує";

  static String m6(sourceName) => " в джерелі ${sourceName}";
  ...
  static String m8(name) => "Видалити ${name} компонент?";

  static String m9(duplicates) => "Знайдено дубликати:\n${duplicates}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addChildren": MessageLookupByLibrary.simpleMessage("Додати залежності?"),
    "addChildrenContent": m0,
    "addComponent": MessageLookupByLibrary.simpleMessage("Додати компонент"),
    ...
    "addVariableFailureTitle": MessageLookupByLibrary.simpleMessage(
      "Не вдалося додати змінну",
    ),
    "alreadyExistsError": m2,
    "alsoReadThis": MessageLookupByLibrary.simpleMessage("Також прочитайте це"),
    ...
    "cityOrLocality": MessageLookupByLibrary.simpleMessage(
      " Місто або локація",
    ),
    "clear": MessageLookupByLibrary.simpleMessage("Очистити"),
    "colorStyles": MessageLookupByLibrary.simpleMessage("Кольори"),
    "componentName": MessageLookupByLibrary.simpleMessage("Назва компонента"),
    ...
    "dataComponent": MessageLookupByLibrary.simpleMessage("Компонент даних"),
    "dataComponentExistsError": m5,
    "dataComponentExistsInSource": m6,
    "dataComponents": MessageLookupByLibrary.simpleMessage("Компоненти даних"),
    ...
    "figmaFileKey": MessageLookupByLibrary.simpleMessage("Ключ файлу Figma"),
    ...
    "firstLastName": MessageLookupByLibrary.simpleMessage(" Ім\'я та прізвище"),
    "flavorName": MessageLookupByLibrary.simpleMessage("Назва флавора"),
    "flavorize": MessageLookupByLibrary.simpleMessage("Генерувати флавори?"),
    ...
    "importApi": MessageLookupByLibrary.simpleMessage(
      "Імпортувати запити REST API",
    ),
    "importStyles": MessageLookupByLibrary.simpleMessage("Імпортувати Стилі"),
    ...
    "modifyComponent": MessageLookupByLibrary.simpleMessage(
      "Змінити компонент",
    ),
    ...
    "parseSwaggerFile": MessageLookupByLibrary.simpleMessage(
      "Парсити Swagger файл",
    ),
    "pasteJsonHere": MessageLookupByLibrary.simpleMessage("Вставте JSON сюди"),
    ...
    "pathNotSelectedTitle": MessageLookupByLibrary.simpleMessage(
      "Шлях до проекту не вибрано",
    ),
    "placeURLTitle": MessageLookupByLibrary.simpleMessage("Вставте URL сюди"),
    "platforms": MessageLookupByLibrary.simpleMessage("Платформи"),
    "preview": MessageLookupByLibrary.simpleMessage("Перегляд"),
    "projectArch": MessageLookupByLibrary.simpleMessage("Архітектура проекту"),
    ...
    "screenAlreadyExistsTitle": MessageLookupByLibrary.simpleMessage("Вже є"),
    ...
    "spaceSeparated": MessageLookupByLibrary.simpleMessage(
      "(розділяти пробілами)",
    ),
    ...
    "withComponents": MessageLookupByLibrary.simpleMessage("З компонентами"),
